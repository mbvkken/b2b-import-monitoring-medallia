...
async function checkDataExtension() {
  try {
    const response = await axios.get(`${SERVER_BASE_URL}/api/data-extension?id=YOUR_DATA_EXTENSION_ID`);
...
// Invoke the function to check the data extension
checkDataExtension();
